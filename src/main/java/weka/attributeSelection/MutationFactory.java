/*  MutationFactory.java in jMetal library: 
...
/**
 * This class allows you to create different mutation operators.
 *
 */
public class MutationFactory {
	...
	throws EvolutionaryException {
		...
		if (name.equalsIgnoreCase("BitFlipMutation")) {
			...
			throw new EvolutionaryException("Mutation Operator: '" + name + "'not found'!");
		} // if-name
